...
public final class Constants {
    ...
    public static final String SF_PROJECT_NAME = "zenx";
    public static final String SF_PROJECT_ROOT_PATH = "Q";
    ...
    public static final String PROP_BUILD_VERSION = "ro.zenx.version";
    public static final String PROP_BUILD_VERSION_INCREMENTAL = "ro.build.version.incremental";
    public static final String PROP_DEVICE = "ro.zenx.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.zenx.build.status";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "zenx.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "zenx.updater.uri";
